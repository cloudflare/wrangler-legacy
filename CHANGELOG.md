...
-   ### Features
    ...
    -   **Add support for text blob bindings - [xortive], [pull/1543], [issue/483]**
        ...
        [pull/1543]: https://github.com/cloudflare/wrangler-legacy/pull/1543
...
-   ### Fixes
    ...
    -   **Eliminate downtime when redeploying Workers Sites - [ashleymichal], [issue/783], [pull/1115]**
        ...
        [issue/783]: https://github.com/cloudflare/wrangler-legacy/issues/783
...
-   ### Features
    ...
    -   **Plain text binding support - [EverlastingBugstopper] - [issue/993] [pull/1014]**
        ...
        [issue/993]: https://github.com/cloudflare/wrangler-legacy/issues/993
...
-   ### Maintenance
    ...
    -   **Zip .tar files in CI - [EverlastingBugstopper], [pull/1069] [pull/1080]**
        ...
        [pull/1080]: https://github.com/cloudflare/wrangler-legacy/pull/1080
        [pull/1069]: https://github.com/cloudflare/wrangler-legacy/pull/1069
    ...
    -   **Fixes clippy warnings - [EverlastingBugstopper], [pull/1071]**
        ...
        [pull/1071]: https://github.com/cloudflare/wrangler-legacy/pull/1071
    ...
    -   **Extract upload and deploy to lib modules - [ashleymichal], [pull/1075]**
        ...
        [pull/1075]: https://github.com/cloudflare/wrangler-legacy/pull/1075
...
-   ### Features
    ...
    -   **Do not factor in .gitignore into workers sites upload directory traversal - [gabbifish], [issue/958] [pull/981]**
        ...
        [gabbifish]: https://github.com/gabbifish
        [pull/981]: https://github.com/cloudflare/wrangler-legacy/pull/981
        [issue/958]: https://github.com/cloudflare/wrangler-legacy/issues/958
    ...
    -   **Update cloudflare-rs, reqwest, http, uuid - [ashleymichal], [issue/301] [pull/1009]**
        ...
        [ashleymichal]: https://github.com/ashleymichal
        [pull/1009]: https://github.com/cloudflare/wrangler-legacy/pull/1009
        [issue/301]: https://github.com/cloudflare/wrangler-legacy/issues/301
    ...
    -   **Add progress bar during Site upload - [gabbifish], [issue/906] [pull/956]**
        ...
        [gabbifish]: https://github.com/gabbifish
        [pull/956]: https://github.com/cloudflare/wrangler-legacy/pull/956
        [issue/906]: https://github.com/cloudflare/wrangler-legacy/issues/906
    ...
    -   **Allow custom webpack config for Workers Sites projects - [ashleymichal], [issue/905] [pull/957]**
        ...
        [ashleymichal]: https://github.com/ashleymichal
        [pull/957]: https://github.com/cloudflare/wrangler-legacy/pull/957
        [issue/905]: https://github.com/cloudflare/wrangler-legacy/issues/905
    ...
    -   **Reformat config api-key output - [bradyjoslin], [issue/889] [pull/910]**
        ...
        [bradyjoslin]: https://github.com/bradyjoslin
        [pull/910]: https://github.com/cloudflare/wrangler-legacy/pull/910
        [issue/889]: https://github.com/cloudflare/wrangler-legacy/issues/889
    ...
    -   **Improve error message for `wrangler init --site` when wrangler.toml already exists - [ashleygwilliams], [issue/648] [pull/931]**
        ...
        [pull/931]: https://github.com/cloudflare/wrangler-legacy/pull/931
        [issue/648]: https://github.com/cloudflare/wrangler-legacy/issues/648
    ...
    -   **Add a helpful error message on authentication error - [EverlastingBugstopper], [issue/492] [pull/932]**
        ...
        [everlastingbugstopper]: https://github.com/EverlastingBugstopper
        [pull/932]: https://github.com/cloudflare/wrangler-legacy/pull/932
        [issue/492]: https://github.com/cloudflare/wrangler-legacy/issues/492
    ...
    -   **Provide helpful error when user accidentally puts kv-namespace config under `[site]` - [gabbifish], [issue/798] [pull/937]**
        ...
        [gabbifish]: https://github.com/gabbifish
        [pull/937]: https://github.com/cloudflare/wrangler-legacy/pull/937
        [issue/798]: https://github.com/cloudflare/wrangler-legacy/issues/798
...
-   ### Fixes
    ...
    -   **Don't install `wasm-pack` for `webpack` type projects - [EverlastingBugstopper], [issue/745] [pull/849]**
        ...
        [everlastingbugstopper]: https://github.com/EverlastingBugstopper
        [pull/849]: https://github.com/cloudflare/wrangler-legacy/pull/849
        [issue/745]: https://github.com/cloudflare/wrangler-legacy/issues/745
...
-   ### Maintenance
    ...
    -   **Make Azure use latest `rustc` - [EverlastingBugstopper], [issue/887] [pull/893]**
        ...
        [everlastingbugstopper]: https://github.com/EverlastingBugstopper
        [pull/893]: https://github.com/cloudflare/wrangler-legacy/pull/893
        [issue/887]: https://github.com/cloudflare/wrangler-legacy/issues/887
    ...
    -   **Fix nightly builds - [EverlastingBugstopper], [pull/895], [pull/898]**
        ...
        [everlastingbugstopper]: https://github.com/EverlastingBugstopper
        [pull/895]: https://github.com/cloudflare/wrangler-legacy/pull/895
        [pull/898]: https://github.com/cloudflare/wrangler-legacy/pull/898
    ...
    -   **Fix compiler warnings on windows - [uma0317], [issue/800] [pull/919]**
        ...
        [pull/919]: https://github.com/cloudflare/wrangler-legacy/pull/919
        [issue/800]: https://github.com/cloudflare/wrangler-legacy/issues/800
    ...
    -   **Remove deprecated kv-namespace config check - [ashleymichal], [pull/929]**
        ...
        [ashleymichal]: https://github.com/ashleymichal
        [pull/929]: https://github.com/cloudflare/wrangler-legacy/pull/929
    ...
    -   **Use binary-install for npm - [EverlastingBugstopper], [pull/862]**
        ...
        [everlastingbugstopper]: https://github.com/EverlastingBugstopper
        [pull/862]: https://github.com/cloudflare/wrangler-legacy/pull/862
...
-   ### Features
    ...
    -   **_BREAKING CHANGE_: Require the `webpack_config` field in `wrangler.toml` to build with a custom configuration - [EverlastingBugstopper], [issue/296] [pull/847]**
        ...
        [everlastingbugstopper]: https://github.com/EverlastingBugstopper
        [pull/847]: https://github.com/cloudflare/wrangler-legacy/pull/847
        [issue/296]: https://github.com/cloudflare/wrangler-legacy/issues/296
    ...
    -   **API Token Support - [gabbifish]/[ashleymichal], [issue/354] [pull/471]/[pull/879]**
        ...
        [gabbifish]: https://github.com/gabbifish
        [ashleymichal]: https://github.com/ashleymichal
        [pull/471]: https://github.com/cloudflare/wrangler-legacy/pull/471
        [pull/879]: https://github.com/cloudflare/wrangler-legacy/pull/879
        [issue/354]: https://github.com/cloudflare/wrangler-legacy/issues/354
    ...
    -   **Add the ability to preview without opening the browser - [EverlastingBugstopper], [issue/256] [pull/816]**
        ...
        [everlastingbugstopper]: https://github.com/EverlastingBugstopper
        [pull/816]: https://github.com/cloudflare/wrangler-legacy/pull/816
        [issue/256]: https://github.com/cloudflare/wrangler-legacy/issues/256
    ...
    -   **Check for valid credentials when running `wrangler config` - [gabbifish], [issue/439] [pull/842]**
        ...
        [gabbifish]: https://github.com/gabbifish
        [pull/842]: https://github.com/cloudflare/wrangler-legacy/pull/842
        [issue/439]: https://github.com/cloudflare/wrangler-legacy/issues/439
    ...
    -   **Add a warning when publishing a Workers Site to a route without a trailing asterisk - [EverlastingBugstopper], [issue/814] [pull/839]**
        ...
        [everlastingbugstopper]: https://github.com/EverlastingBugstopper
        [pull/839]: https://github.com/cloudflare/wrangler-legacy/pull/839
        [issue/814]: https://github.com/cloudflare/wrangler-legacy/issues/814
    ...
    -   **Better error message for publishing to a duplicate route - [pradovic], [issue/519] [pull/813]**
        ...
        [pull/813]: https://github.com/cloudflare/wrangler-legacy/pull/813
        [issue/519]: https://github.com/cloudflare/wrangler-legacy/issues/519
    ...
    -   **Better error message when webpack fails - [ashleymichal], [issue/428] [pull/837]**
        ...
        [ashleymichal]: https://github.com/ashleymichal
        [pull/837]: https://github.com/cloudflare/wrangler-legacy/pull/837
        [issue/428]: https://github.com/cloudflare/wrangler-legacy/issues/428
...
-   ### Fixes
    ...
    -   **Properly handle errors when running Wrangler as a global npm package - [jaredmcdonald], [issue/848] [pull/857]**
        ...
        [pull/857]: https://github.com/cloudflare/wrangler-legacy/pull/857
        [issue/848]: https://github.com/cloudflare/wrangler-legacy/issues/848
    ...
    -   **Clean up temporary build files - [EverlastingBugstopper], [pull/853]**
        ...
        [everlastingbugstopper]: https://github.com/EverlastingBugstopper
        [pull/853]: https://github.com/cloudflare/wrangler-legacy/pull/853
    ...
    -   **Fix the help text for `wrangler generate` - [EverlastingBugstopper], [pull/830]**
        ...
        [everlastingbugstopper]: https://github.com/EverlastingBugstopper
        [pull/830]: https://github.com/cloudflare/wrangler-legacy/pull/830
    ...
    -   **Remove --version on subcommands - [EverlastingBugstopper], [issue/791] [pull/829]**
        ...
        [everlastingbugstopper]: https://github.com/EverlastingBugstopper
        [pull/829]: https://github.com/cloudflare/wrangler-legacy/pull/829
        [issue/791]: https://github.com/cloudflare/wrangler-legacy/issues/791

    -   **Fix a broken link in the README - [victoriabernard92], [pull/838]**

        [victoriabernard92]: https://github.com/victoriabernard92
        [pull/838]: https://github.com/cloudflare/wrangler-legacy/pull/838
...
-   ### Maintenance
    ...
    -   **Create fixtures programmatically - [EverlastingBugstopper], [pull/854]**
        ...
        [everlastingbugstopper]: https://github.com/EverlastingBugstopper
        [pull/854]: https://github.com/cloudflare/wrangler-legacy/pull/854

    -   **Clean up Workers Sites logic - [ashleymichal], [issue/622] [issue/643] [pull/851]**

        [ashleymichal]: https://github.com/ashleymichal
        [pull/851]: https://github.com/cloudflare/wrangler-legacy/pull/851
        [issue/622]: https://github.com/cloudflare/wrangler-legacy/issues/622
        [issue/643]: https://github.com/cloudflare/wrangler-legacy/issues/643
    ...
    -   **Call cloudflare-rs from https.rs - [gabbifish], [pull/841]**
        ...
        [gabbifish]: https://github.com/gabbifish
        [pull/841]: https://github.com/cloudflare/wrangler-legacy/pull/841

    -   **Audit code comments - [EverlastingBugstopper], [pull/846]**

        [everlastingbugstopper]: https://github.com/EverlastingBugstopper
        [pull/846]: https://github.com/cloudflare/wrangler-legacy/pull/846
    ...
    -   **Update the author of the npm package - [EverlastingBugstopper], [pull/836]**
        ...
        [everlastingbugstopper]: https://github.com/EverlastingBugstopper
        [pull/836]: https://github.com/cloudflare/wrangler-legacy/pull/836
    ...
    -   **Remove unused code warnings when running tests - [pradovic], [issue/818] [pull/832]**
        ...
        [pradovic]: https://github.com/pradovic
        [pull/832]: https://github.com/cloudflare/wrangler-legacy/pull/832
        [issue/818]: https://github.com/cloudflare/wrangler-legacy/issues/818

    -   **Use the same binding name for Rust and webpack wasm modules - [ashleymichal], [pull/822]**

        [ashleymichal]: https://github.com/ashleymichal
        [pull/822]: https://github.com/cloudflare/wrangler-legacy/pull/822

    -   **Move the code for each subcommand to its own directory - [EverlastingBugstopper], [pull/831]**

        [everlastingbugstopper]: https://github.com/EverlastingBugstopper
        [pull/831]: https://github.com/cloudflare/wrangler-legacy/pull/831
    ...
    -   **Refactor upload forms - [ashleymichal], [pull/826]**
        ...
        [ashleymichal]: https://github.com/ashleymichal
        [pull/826]: https://github.com/cloudflare/wrangler-legacy/pull/826
    ...
    -   **Pull npm version from package.json - [EverlastingBugstopper], [issue/812] [pull/817]**
        ...
        [everlastingbugstopper]: https://github.com/EverlastingBugstopper
        [pull/817]: https://github.com/cloudflare/wrangler-legacy/pull/817
        [issue/812]: https://github.com/cloudflare/wrangler-legacy/issues/812
...
-   ### Documentation
    ...
    -   **Move Wrangler docs from READMEs to the Cloudflare Workers documentation site - [victoriabernard92], [pull/823]**
        ...
        [victoriabernard92]: https://github.com/victoriabernard92
        [pull/823]: https://github.com/cloudflare/wrangler-legacy/pull/823
    ...
    -   **Update the demo gif in the README - [EverlastingBugstopper], [issue/843] [pull/868]**
        ...
        [everlastingbugstopper]: https://github.com/EverlastingBugstopper
        [pull/868]: https://github.com/cloudflare/wrangler-legacy/pull/868
        [issue/843]: https://github.com/cloudflare/wrangler-legacy/issues/843
...
-   ### Features
    ...
    -   **Deprecate `private` field in `wrangler.toml` - [stevenfranks], [issue/782] [pull/782]**
        ...
        [pull/782]: https://github.com/cloudflare/wrangler-legacy/pull/782
        [issue/782]: https://github.com/cloudflare/wrangler-legacy/issues/782
    ...
    -   **Include/exclude static assets in a Workers Sites project - [gabbifish], [issue/716] [pull/760]**
        ...
        [issue/716]: https://github.com/cloudflare/wrangler-legacy/issues/716
        [pull/760]: https://github.com/cloudflare/wrangler-legacy/pull/760
    ...
    -   **A more robust `wrangler generate` - [EverlastingBugstopper], [issue/315] [pull/759]**
        ...
        [issue/315]: https://github.com/cloudflare/wrangler-legacy/issues/315
        [pull/759]: https://github.com/cloudflare/wrangler-legacy/pull/759
    ...
    -   **Add the ability to check if you've already registered a workers.dev subdomain - [gusvargas], [issue/701] [pull/747]**
        ...
        [pull/747]: https://github.com/cloudflare/wrangler-legacy/pull/747
        [issue/701]: https://github.com/cloudflare/wrangler-legacy/issues/701
    ...
    -   **Add `--verbose` flag to `wrangler publish` and `wrangler preview` - [gabbifish], [issue/657] [pull/790]**
        ...
        [issue/657]: https://github.com/cloudflare/wrangler-legacy/issues/657
        [pull/790]: https://github.com/cloudflare/wrangler-legacy/pull/790
    ...
    -   **Disallow `node_modules` as a bucket for Workers Sites - [gabbifish], [issue/723] [pull/792]**
        ...
        [issue/723]: https://github.com/cloudflare/wrangler-legacy/pull/792
        [pull/792]: https://github.com/cloudflare/wrangler-legacy/issues/723
    ...
    -   **Allow installs to utilize Wrangler binaries via a caching proxy instead of GitHub directly - [gabbifish], [pull/797]**
        ...
        [gabbifish]: https://github.com/cloudflare/wrangler-legacy/pull/797
    ...
    -   **Provide a better error message when using an unverified email address - [ashleygwilliams], [issue/320] [pull/795]**
        ...
        [issue/320]: https://github.com/cloudflare/wrangler-legacy/issues/320
        [pull/795]: https://github.com/cloudflare/wrangler-legacy/pull/795
...
-   ### Fixes
    ...
    -   **Fix Rust live preview - [gabbifish], [issue/618] [pull/699]**
        ...
        [issue/618]: https://github.com/cloudflare/wrangler-legacy/issues/618
        [pull/699]: https://github.com/cloudflare/wrangler-legacy/pull/699
    ...
    -   **Minimize timeout errors for bulk uploads - [gabbifish], [issue/746] [pull/757]**
        ...
        [issue/746]: https://github.com/cloudflare/wrangler-legacy/issues/746
        [pull/757]: https://github.com/cloudflare/wrangler-legacy/pull/757
    ...
    -   **Print readable error message when external commands fail - [EverlastingBugstopper], [pull/799]**
        ...
        [pull/799]: https://github.com/cloudflare/wrangler-legacy/pull/799
    ...
    -   **Disallow `wrangler generate --site` with a template argument - [EverlastingBugstopper], [issue/776] [pull/789]**
        ...
        [issue/776]: https://github.com/cloudflare/wrangler-legacy/issues/776
        [pull/789]: https://github.com/cloudflare/wrangler-legacy/pull/789
...
-   ### Features
    ...
    -   **Workers Sites - [pull/509]**
        ...
        [pull/509]: https://github.com/cloudflare/wrangler-legacy/pull/509

    -   **Download release from our proxy rather than GitHub - [zackbloom], [pull/692]**

        [zackbloom]: https://github.com/zackbloom
        [pull/692]: https://github.com/cloudflare/wrangler-legacy/pull/692
    ...
    -   **Add validation for workers names in wrangler init and wrangler generate - [gabbifish], [issue/470][pull/686]**
        ...
        [gabbifish]: https://github.com/gabbifish
        [issue/470]: https://github.com/cloudflare/wrangler-legacy/issues/470
        [pull/686]: https://github.com/cloudflare/wrangler-legacy/pull/686
    ...
    -   **Ensure KV subcommands check for presence of required fields in wrangler.toml - [gabbifish], [issue/607] [pull/665]**
        ...
        [gabbifish]: https://github.com/gabbifish
        [pull/665]: https://github.com/cloudflare/wrangler-legacy/pull/665
    ...
    -   **Show size when a KV upload error occurs - [stevenfranks], [issue/650] [pull/651]**
        ...
        [stevenfranks]: https://github.com/stevenfranks
        [issue/650]: https://github.com/cloudflare/wrangler-legacy/issues/650
        [pull/651]: https://github.com/cloudflare/wrangler-legacy/pull/651
    ...
    -   **Better file support for kv:put - [phayes], [pull/633]**
        ...
        [pull/633]: https://github.com/cloudflare/wrangler-legacy/pull/633
...
-   ### Fixes
    ...
    **Ensure we install and cache the latest version of cargo-generate and wasm-pack if user has an outdated cargo installed version - [EverlastingBugstopper], [issue/666] [pull/726]**
    ...
    [pull/726]: https://github.com/cloudflare/wrangler-legacy/pull/726
    ...
    -   **Remove link to 000000000000000000.cloudflareworkers.com - [EverlastingBugstopper], [pull]**
        ...
        [everlastingbugstopper]: https://github.com/EverlastingBugstopper
        [pull]: https://github.com/cloudflare/wrangler-legacy/pull/698
    ...
    -   **Make install actually fail if the release can't be downloaded - [zackbloom], [pull/672]**
        ...
        [zackbloom]: https://github.com/zackbloom
        [pull/672]: https://github.com/cloudflare/wrangler-legacy/pull/672
...
-   ### Maintenance
    ...
    -   **KV command error output improvements - [gabbifish], [issue/608] [pull/613]**
        ...
        [gabbifish]: https://github.com/gabbifish
        [issue/608]: https://github.com/cloudflare/wrangler-legacy/pull/608
        [pull/613]: https://github.com/cloudflare/wrangler-legacy/pull/613
    ...
    -   **Added missing word to whoami response - [stevenfranks], [pull/695]**
        ...
        [stevenfranks]: https://github.com/stevenfranks
        [pull/695]: https://github.com/cloudflare/wrangler-legacy/pull/695
...
-   ### Documentation
    ...
    -   **Webpack documentation - [EverlastingBugstopper], [issue/721] [pull/724]**
        ...
        [check them out]: https://github.com/cloudflare/wrangler-legacy/blob/master/docs/content/webpack.md
        [everlastingbugstopper]: https://github.com/EverlastingBugstopper
        [issue/721]: https://github.com/cloudflare/wrangler-legacy/issues/721
        [pull/724]: https://github.com/cloudflare/wrangler-legacy/pull/724
...
-   ### Features
    ...
    -   **Environments - [EverlastingBugstopper], [issue/385][pull/386]**
        ...
        To support developers transitioning to environments, we've written documentation for the feature, including further information about deprecations and advanced usage. [Check out the documentation here!](https://github.com/cloudflare/wrangler-legacy/blob/master/docs/content/environments.md)

        [everlastingbugstopper]: https://github.com/EverlastingBugstopper
        [issue/385]: https://github.com/cloudflare/wrangler-legacy/issues/385
        [pull/386]: https://github.com/cloudflare/wrangler-legacy/pull/386
    ...
    -   **Reduce output from publish command - [EverlastingBugstopper], [issue/523][pull/584]**
        ...
        **After:**
        ...
        [everlastingbugstopper]: https://github.com/EverlastingBugstopper
        [issue/523]: https://github.com/cloudflare/wrangler-legacy/issues/523
        [pull/584]: https://github.com/cloudflare/wrangler-legacy/pull/584
    ...
    -   **feat #323: Allow fn & promise from webpack config - [third774], [issue/323][pull/325]**
        ...
        [issue/323]: https://github.com/cloudflare/wrangler-legacy/issues/323
        [pull/325]: https://github.com/cloudflare/wrangler-legacy/pull/325
    ...
    -   **Use webworker target - [xtuc], [issue/477][pull/490]**
        ...
        [xtuc]: https://github.com/xtuc
        [issue/477]: https://github.com/cloudflare/wrangler-legacy/issues/477
        [pull/490]: https://github.com/cloudflare/wrangler-legacy/pull/490
...
-   ### Fixes
    ...
    -   **Have live reload preview watch over entire rust worker directory - [gabbifish], [pull/535]**
        ...
        [gabbifish]: https://github.com/gabbifish
        [pull/535]: https://github.com/cloudflare/wrangler-legacy/pull/535
    ...
    -   **Fix javascript live preview for linux - [gabbifish], [issue/517][pull/528]**
        ...
        [gabbifish]: https://github.com/gabbifish
        [issue/517]: https://github.com/cloudflare/wrangler-legacy/issues/517
        [pull/528]: https://github.com/cloudflare/wrangler-legacy/pull/528
    ...
    -   **Different emojis for different commands - [EverlastingBugstopper], [pull/605]**
        ...
        [everlastingbugstopper]: https://github.com/EverlastingBugstopper
        [pull/605]: https://github.com/cloudflare/wrangler-legacy/pull/605
...
-   ### Maintenance
    ...
    -   **Add keywords for npm SEO - [EverlastingBugstopper], [pull/583]**
        ...
        [everlastingbugstopper]: https://github.com/EverlastingBugstopper
        [pull/583]: https://github.com/cloudflare/wrangler-legacy/pull/583
    ...
    -   **Clean up emoji - [xortive], [pull/455]**
        ...
        [xortive]: https://github.com/xortive
        [pull/455]: https://github.com/cloudflare/wrangler-legacy/pull/455
...
-   ### Documentation
    ...
    -   **Add documentation for init to the README - [EverlastingBugstopper], [pull/585]**
        ...
        [everlastingbugstopper]: https://github.com/EverlastingBugstopper
        [pull/585]: https://github.com/cloudflare/wrangler-legacy/pull/585

    -   **Remove link to docs for installation because they link back to wrangler README - [EverlastingBugstopper], [pull/494]**

        [everlastingbugstopper]: https://github.com/EverlastingBugstopper
        [pull/494]: https://github.com/cloudflare/wrangler-legacy/pull/494
    ...
    -   **Minor formatting fix in README.md - [kentonv], [pull/515]**
        ...
        [kentonv]: https://github.com/kentonv
        [pull/515]: https://github.com/cloudflare/wrangler-legacy/pull/515
    ...
    -   **Fix link to Cloudflare Workers preview service - [dentarg], [pull/472]**
        ...
        [pull/472]: https://github.com/cloudflare/wrangler-legacy/pull/472
...
-   ### Features
    ...
    -   **Implement live previewing for wrangler - [xortive], [pull/451]**
        ...
        [xortive]: https://github.com/xortive
        [pull/451]: https://github.com/cloudflare/wrangler-legacy/pull/451
    ...
    -   **Authenticate calls to preview service when possible - [ashleymichal], [issue/423][issue/431] [pull/429]**
        ...
        [ashleymichal]: https://github.com/ashleymichal
        [issue/423]: https://github.com/cloudflare/wrangler-legacy/issues/423
        [issue/431]: https://github.com/cloudflare/wrangler-legacy/issues/431
        [pull/429]: https://github.com/cloudflare/wrangler-legacy/pull/429
...
-   ### Documentation
    ...
    -   **Cleanup README and link to workers docs - [EverlastingBugstopper], [pull/440]**
        ...
        [everlastingbugstopper]: https://github.com/EverlastingBugstopper
        [pull/440]: https://github.com/cloudflare/wrangler-legacy/pull/440
    ...
    -   **Link to docs for update instructions - [ashleymichal], [pull/422]**
        ...
        [ashleymichal]: https://github.com/ashleymichal
        [pull/422]: https://github.com/cloudflare/wrangler-legacy/pull/422
...
-   ### Fixes
    ...
    -   **Fix ignoring exit code from spawnSync - run-wrangler.js - [defjosiah], [issue/433][issue/335] [pull/432]**
        ...
        [issue/433]: https://github.com/cloudflare/wrangler-legacy/issues/433
        [issue/335]: https://github.com/cloudflare/wrangler-legacy/issues/335
        [pull/432]: https://github.com/cloudflare/wrangler-legacy/pull/432
...
-   ### Maintenance
    ...
    -   **Test maintenance - [EverlastingBugstopper], [pull/563]**
        ...
        [everlastingbugstopper]: https://github.com/EverlastingBugstopper
        [pull/563]: https://github.com/cloudflare/wrangler-legacy/pull/563
    ...
    -   **Guard test against potential races - [xtuc], [pull/567]**
        ...
        [xtuc]: https://github.com/xtuc
        [pull/567]: https://github.com/cloudflare/wrangler-legacy/pull/567
    ...
    -   **Deny clippy warnings in CI, run rustfmt in --check mode - [xortive], [issue/426][pull/435]**
        ...
        [xortive]: https://github.com/xortive
        [issue/426]: https://github.com/cloudflare/wrangler-legacy/issues/426
        [pull/435]: https://github.com/cloudflare/wrangler-legacy/pull/435

    -   **Nits: fix clippy warnings - [xortive], [pull/427]**

        [xortive]: https://github.com/xortive
        [pull/427]: https://github.com/cloudflare/wrangler-legacy/pull/427

    -   **Add repository link to Cargo.toml - [56quarters], [pull/425]**

        [56quarters]: https://github.com/56quarters
        [pull/425]: https://github.com/cloudflare/wrangler-legacy/pull/425
...
-   ### Features
    ...
    -   **Install current version, not latest - [ashleygwilliams], [issue/418][pull/419]**
        ...
        [ashleygwilliams]: https://github.com/ashleygwilliams
        [issue/418]: https://github.com/cloudflare/wrangler-legacy/issues/418
        [pull/419]: https://github.com/cloudflare/wrangler-legacy/pull/419
    ...
    -   **Improve JSON errors debuggability - [xtuc], [pull/394]**
        ...
        [xtuc]: https://github.com/xtuc
        [pull/394]: https://github.com/cloudflare/wrangler-legacy/pull/394
...
-   ### Fixes
    ...
    -   **Fix `wrangler config` for systems with non-unix EOL - [xortive], [issue/389][pull/399]**
        ...
        [xortive]: https://github.com/xortive
        [issue/389]: https://github.com/cloudflare/wrangler-legacy/issues/389
        [pull/399]: https://github.com/cloudflare/wrangler-legacy/pull/399
...
-   ### Maintenance
    ...
    -   **Migrate straggler emojis to terminal::emoji - [EverlastingBugstopper], [pull/382]**
        ...
        [everlastingbugstopper]: https://github.com/EverlastingBugstopper
        [pull/382]: https://github.com/cloudflare/wrangler-legacy/pull/382
    ...
    -   **Move test fixtures to their own directory - [EverlastingBugstopper], [pull/383]**
        ...
        [everlastingbugstopper]: https://github.com/EverlastingBugstopper
        [pull/383]: https://github.com/cloudflare/wrangler-legacy/pull/383
    ...
    -   **Update issue templates to fit GitHub's data model - [EverlastingBugstopper], [pull/387]**
        ...
        [everlastingbugstopper]: https://github.com/EverlastingBugstopper
        [pull/387]: https://github.com/cloudflare/wrangler-legacy/pull/387
    ...
    -   **Move Emoji formatting/messaging into new functions - [ashleymichal], [pull/391]**
        ...
        [ashleymichal]: https://github.com/ashleymichal
        [pull/391]: https://github.com/cloudflare/wrangler-legacy/pull/391
...
-   ### Documentation
    ...
    -   **Update README to include config, env var changes - [ashleymichal], [pull/379]**
        ...
        [ashleymichal]: https://github.com/ashleymichal
        [pull/379]: https://github.com/cloudflare/wrangler-legacy/pull/379
    ...
    -   **Add section to readme about Vendored OpenSSL - [xortive], [pull/407]**
        ...
        [xortive]: https://github.com/xortive
        [pull/407]: https://github.com/cloudflare/wrangler-legacy/pull/407
...
-   ### Security
    ...
    -   **Change global config perm - [xtuc], [pull/286]**
        ...
        [xtuc]: https://github.com/xtuc
        [pull/286]: https://github.com/cloudflare/wrangler-legacy/pull/286#event-2516759398
    ...
    -   **Use stdin instead of arguments for wrangler config - [xtuc], [pull/329]**
        ...
        [xtuc]: https://github.com/xtuc
        [pull/329]: https://github.com/cloudflare/wrangler-legacy/pull/239
...
*   ### Features
    ...
    -   **Support KV Namespace Configuration - [ashleymichal], [pull/334], add check + error message for pre 1.1.0 kv namespace format - [xortive], [pull/369]**
        ...
        **If you were previously using the undocumented `kv-namespaces` support in your project config, you'll need to make a few changes to your project to use Wrangler 1.1.0!** KV namespaces now need to be created manually, in the Cloudflare Dashboard, to be able to use them in your Wrangler configuration - previous versions of Wrangler created the namespace for you, but the process is now manual, to allow developers to be more explicit about how their KV namespaces are created.
        ...
        [xortive]: https://github.com/xortive
        [pull/369]: https://github.com/cloudflare/wrangler-legacy/pull/369

        This is the initial part of a lot of incredible work being done on supporting Workers KV in Wrangler. If you're interested in what's up next, check out our [next milestone](https://github.com/cloudflare/wrangler-legacy/milestone/7).

        [ashleymichal]: https://github.com/ashleymichal
        [pull/334]: https://github.com/cloudflare/wrangler-legacy/pull/334

    -   **Configure Workers KV in your wrangler.toml - [ashleymichal], [pull/333]**

        If you've tried to use [Workers KV][kv] in Wrangler, you've probably had a bad time! This PR, along with [#334](https://github.com/cloudflare/wrangler-legacy/pull/334), build support for handling and correctly uploading KV namespace information with your Wrangler project:
        ...
        [ashleymichal]: https://github.com/ashleymichal
        [pull/333]: https://github.com/cloudflare/wrangler-legacy/pull/333
    ...
    -   **Use ENV variables to configure Wrangler - [AaronO], [pull/225]**
        ...
        [pull/225]: https://github.com/cloudflare/wrangler-legacy/pull/225
    ...
    -   **Adds more descriptive subdomain errors - [EverlastingBugstopper], [issue/207][pull/259]**
        ...
        [everlastingbugstopper]: https://github.com/EverlastingBugstopper
        [issue/207]: https://github.com/cloudflare/wrangler-legacy/issue/207
        [pull/259]: https://github.com/cloudflare/wrangler-legacy/pull/259
    ...
    -   **Allow custom webpack configuration in wrangler.toml - [EverlastingBugstopper], [issue/246][pull/253]**
        ...
        [everlastingbugstopper]: https://github.com/EverlastingBugstopper
        [issue/246]: https://github.com/cloudflare/wrangler-legacy/issue/246
        [pull/253]: https://github.com/cloudflare/wrangler-legacy/pull/253
    ...
    -   **Add issue templates for bug reports and feature requests - [gabbifish], [issue/250][pull/350]**
        ...
        [gabbifish]: https://github.com/gabbifish
        [issue/250]: https://github.com/cloudflare/wrangler-legacy/issue/250
        [pull/350]: https://github.com/cloudflare/wrangler-legacy/pull/350
    ...
    -   **Display commands in their defined order - [Electroid], [pull/236]**
        ...
        [electroid]: https://github.com/Electroid
        [pull/233]: https://github.com/cloudflare/wrangler-legacy/pull/236
    ...
    -   **Show project size on build - [xtuc], [pull/205]**
        ...
        [xtuc]: https://github.com/xtuc
        [pull/205]: https://github.com/cloudflare/wrangler-legacy/pull/205
    ...
    -   **Add HTTP prefix to publish command output. - [elithrar], [pull/198]**
        ...
        [pull/198]: https://github.com/cloudflare/wrangler-legacy/pull/198
    ...
    -   **Build: add message and emoji - [xtuc], [pull/193]**
        ...
        [xtuc]: https://github.com/xtuc
        [pull/193]: https://github.com/cloudflare/wrangler-legacy/pull/193
...
-   ### 🤕 Fixes
    ...
    -   **Remove OpenSSL installation step from README - [xortive], [issue/355][pull/356]**
        ...
        [xortive]: https://github.com/xortive
        [issue/355]: https://github.com/cloudflare/wrangler-legacy/issues/355
        [pull/356]: https://github.com/cloudflare/wrangler-legacy/pull/356
    ...
    -   **Fix issue previewing a project with KV namespaces - [ashleymichal], [pull/353]**
        ...
        [ashleymichal]: https://github.com/ashleymichal
        [pull/353]: https://github.com/cloudflare/wrangler-legacy/pull/353
    ...
    -   **Enforce one Webpack entry in configuration - [xtuc], [pull/245]**
        ...
        [xtuc]: https://github.com/xtuc
        [pull/245]: https://github.com/cloudflare/wrangler-legacy/pull/245
    ...
    -   **Update default template for Rust project type - [EverlastingBugstopper], [pull/309]**
        ...
        [pull/309]: https://github.com/cloudflare/wrangler-legacy/pull/309
    ...
    -   **Stop cleaning webpack build artifacts - [EverlastingBugstopper], [pull/307]**
        ...
        [pull/307]: https://github.com/cloudflare/wrangler-legacy/pull/307
    ...
    -   **Correct binding format - [xtuc], [pull/260]**
        ...
        [xtuc]: https://github.com/xtuc
        [pull/260]: https://github.com/cloudflare/wrangler-legacy/pull/260
    ...
    -   **Correctly pass Wasm module - [xtuc], [pull/261]**
        ...
        [xtuc]: https://github.com/xtuc
        [pull/261]: https://github.com/cloudflare/wrangler-legacy/pull/261
    ...
    -   **Check for `account_id` and `zone_id` before publishing - [xtuc], [issue/170][pull/192]**
        ...
        [xtuc]: https://github.com/xtuc
        [issue/170]: https://github.com/cloudflare/wrangler-legacy/issues/170
        [pull/192]: https://github.com/cloudflare/wrangler-legacy/pull/192
...
*   ### 📖 Documentation
    ...
    -   **Update README to include KV config info - [ashleymichal], [pull/319]**
        ...
        [ashleymichal]: https://github.com/ashleymichal
        [pull/319]: https://github.com/cloudflare/wrangler-legacy/pull/319

    -   **Clarified intro link in README - [tomByrer], [pull/257]**

        [tombyrer]: https://github.com/tomByrer
        [pull/257]: https://github.com/cloudflare/wrangler-legacy/pull/257

    -   **Make it more clear that you can install Wrangler though npm - [zackbloom], [pull/241]**

        [zackbloom]: https://github.com/zackbloom
        [pull/241]: https://github.com/cloudflare/wrangler-legacy/pull/241

    -   **Document (lightly) the Wrangler 1.0.0 release - [signalnerve], [pull/204]**

        [signalnerve]: https://github.com/signalnerve
        [pull/204]: https://github.com/cloudflare/wrangler-legacy/pull/204

    -   **Add README for Wrangler.js package - [ashleygwilliams], [pull/196]**

        [ashleygwilliams]: https://github.com/ashleygwilliams
        [pull/196]: https://github.com/cloudflare/wrangler-legacy/pull/196
...
*   ### 🔧 Maintenance
    ...
    -   **Better error printing - [xortive], [pull/327]**
        ...
        [xortive]: https://github.com/xortive
        [pull/327]: https://github.com/cloudflare/wrangler-legacy/pull/327
    ...
    -   **Always use multipart upload - [ashleymichal], [issue/280][pull/328]**
        ...
        [ashleymichal]: https://github.com/ashleymichal
        [issue/280]: https://github.com/cloudflare/wrangler-legacy/issue/280
        [pull/328]: https://github.com/cloudflare/wrangler-legacy/pull/328
    ...
    -   **unify upload form building - [ashleymichal], [pull/329]**
        ...
        [ashleymichal]: https://github.com/ashleymichal
        [pull/329]: https://github.com/cloudflare/wrangler-legacy/pull/329
    ...
    -   **`wrangler preview` integration tests - [EverlastingBugstopper], [pull/363]**
        ...
        [everlastingbugstopper]: https://github.com/EverlastingBugstopper
        [pull/363]: https://github.com/cloudflare/wrangler-legacy/pull/363
    ...
    -   **Add user agent - [xtuc], [issue/234][pull/236]**
        ...
        [xtuc]: https://github.com/xtuc
        [issue/234]: https://github.com/cloudflare/wrangler-legacy/issue/234
        [pull/236]: https://github.com/cloudflare/wrangler-legacy/pull/236
    ...
    -   **Terminal messaging abstraction - [ashleymichal], [issue/219][pull/263]**
        ...
        [ashleymichal]: https://github.com/ashleymichal
        [issue/219]: https://github.com/cloudflare/wrangler-legacy/issues/219
        [pull/263]: https://github.com/cloudflare/wrangler-legacy/pull/263
    ...
    -   **Remove pre-push hooks - [EverlastingBugstopper], [pull/308]**
        ...
        [pull/308]: https://github.com/cloudflare/wrangler-legacy/pull/308
    ...
    -   **Use serde for metadata - [xtuc], [pull/285]**
        ...
        [pull/285]: https://github.com/cloudflare/wrangler-legacy/pull/285
    ...
    -   **Refactor: Conditional per command in main - [ashleymichal], [pull/279]**
        ...
        [ashleymichal]: https://github.com/ashleymichal
        [pull/279]: https://github.com/cloudflare/wrangler-legacy/pull/279
    ...
    -   **Add an authenticated HTTP client - [Electroid], [issue/238][pull/267]**
        ...
        [electroid]: https://github.com/Electroid
        [issue/238]: https://github.com/cloudflare/wrangler-legacy/issue/238
        [pull/267]: https://github.com/cloudflare/wrangler-legacy/pull/267

    -   **Move metadata generation at publish-time - [xtuc], [pull/237]**

        [author]: https://github.com/xtuc
        [pull/237]: https://github.com/cloudflare/wrangler-legacy/pull/237
    ...
    -   **Pin webpack version - [xtuc], [pull/228]**
        ...
        [xtuc]: https://github.com/xtuc
        [pull/228]: https://github.com/cloudflare/wrangler-legacy/pull/228

    -   **Remove empty file - [xtuc], [pull/216]**

        [xtuc]: https://github.com/xtuc
        [pull/216]: https://github.com/cloudflare/wrangler-legacy/pull/216

    -   **test: improve metadata coverage - [xtuc], [pull/214]**

        [xtuc]: https://github.com/xtuc
        [pull/214]: https://github.com/cloudflare/wrangler-legacy/pull/214

    -   **Reorganize wranglerjs src - [xtuc], [pull/202][issue/154] [issue/155]**

        [xtuc]: https://github.com/xtuc
        [issue/154]: https://github.com/cloudflare/wrangler-legacy/issue/154
        [issue/155]: https://github.com/cloudflare/wrangler-legacy/issue/155
        [pull/202]: https://github.com/cloudflare/wrangler-legacy/pull/202

    -   **Minor spelling fix - [adaptive], [pull/200]**

        [adaptive]: https://github.com/adaptive
        [pull/200]: https://github.com/cloudflare/wrangler-legacy/pull/200
...
-   ### 🤕 Fixes
    ...
    -   **Fix `publish` and `preview` bug for projects with a `-` - [jaysonsantos], [issue/36][pull/38]**
        ...
        [issue/36]: https://github.com/cloudflare/wrangler-legacy/issues/36
        [pull/38]: https://github.com/cloudflare/wrangler-legacy/pull/38
...
-   ### 📖 Documentation
    ...
    -   **Install instructions with OpenSSL troubleshooting notes - [AustinCorridor], [issue/35][pull/43]**
        ...
        [issue/35]: https://github.com/cloudflare/wrangler-legacy/issues/35
        [pull/43]: https://github.com/cloudflare/wrangler-legacy/pull/43
    ...
    -   **Typo and casing fixes - [neynah], [pull/42]**
        ...
        [pull/42]: https://github.com/cloudflare/wrangler-legacy/pull/42
