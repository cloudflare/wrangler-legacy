...
pub enum Binding {
    ...
    ActorNamespace { name: String, namespace_id: String },
...
impl Binding {
    ...
    pub fn new_actor_namespace(name: String, namespace_id: String) -> Binding {
        Binding::ActorNamespace { name, namespace_id }
    }
